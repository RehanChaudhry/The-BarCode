...
protocol ChalkBoardViewControllerDelegate: class {
...
class ChalkBoardViewController: UIViewController {
    ...
    weak var delegate: ChalkBoardViewControllerDelegate!
...
extension ChalkBoardViewController: UITableViewDataSource, UITableViewDelegate {
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        self.delegate.chalkBoardViewController(controller: self, didSelect: deal)
    }
}

//MARK: DealTableViewCellDelegate
extension ChalkBoardViewController: DealTableViewCellDelegate {
...
extension ChalkBoardViewController: StatefulTableDelegate {
