...
class OutOfCreditViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        if self.hasCredits && self.canReload {
            ...
            self.detailLabel.text = "This bar offers unlimited redemption. Pay \(Utility.shared.regionalInfo.currencySymbol)\(Utility.shared.regionalInfo.reload) and you can redeem any offer till the bar closes. \n\nGet more credits by sharing offers or inviting friends"
